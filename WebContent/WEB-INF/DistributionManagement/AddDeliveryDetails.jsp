...
<link href="css/customText.css" rel="stylesheet">
...
<body>
	...
	<nav class="navbar fixed-top navbar-expand-lg navbar-dark"
		...
		<a class="navbar-brand " href="#" style="padding-right: 3%"> 
		<img class="logo" src="Images/logo.png" alt="Home"></a>
     ...
     <div class="col-md-12">
         <div class="card mb-3" >
             <div class="card-header" style="color: #003399" >
                 <h5><span class="fa fa-image"></span> Details </h5></div>
             <div class="card-body">
  ...
  <form class="form-horizontal" action="/action_page.php">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">          
        ...
        <input type="text" class="form-control" id="usr" placeholder="" name="text">
      </div>
    </div>
    ...
    <div class="form-group">
   		 ...
   		 <label class="control-label col-sm-2" for="name">SR ID:</label>
        <div class="col-sm-10"> 
 		 <input type="dropdpwn" class="form-control" id="usr">
          </div>
	</div>
