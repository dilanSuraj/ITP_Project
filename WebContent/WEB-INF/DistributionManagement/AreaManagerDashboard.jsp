 ...
 <div class="col-md-2 position-fixed d-none d-md-block" style="background-color: #003399;height: 100%;padding-top: 60px;">
     <nav class="navbar  navbar-expand-lg navbar-dark"  style="padding-top: 30px;padding-left:0%">
         ...
         <ul class="nav flex-column sidbar-items">
             ...
             <li class="nav-item"><a class="nav-link" href="AddDeliveryDetails"><span
						class="fa fa-id-card-o" style="font-size: 18px"></span> Add Delivery Details</a></li>
			...
			<li class="nav-item"><a class="nav-link" href="Extra_Stock_View"><span
						class="fa fa-cart-plus" style="font-size: 18px"></span> Add Extra Stocks</a></li>
