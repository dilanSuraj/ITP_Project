			...
			<div class="col-md-12">
				<div class="card mb-3">
					<div class="card-header" style="color: #003399">
						<h5>
							<span class="fa fa-image"></span> Stocks
						</h5>
					</div>
					<div class="card-body">
						...
						<div class="container">
							...
							<form:form class="form-horizontal" method="post"
								onSubmit="return confirm('Do you want to add extra stocks')"
								action="Extra_Stock_Details_POST" modelAttribute="extrastock">
								...
								<div class="form-group">
									...
									<div class="col-sm-10">
										...
										<form:input type="number" min="1" class="form-control"
											id="usr" path="extra_stock_quantity" name="text"
											required="required" />
									</div>
								</div>
