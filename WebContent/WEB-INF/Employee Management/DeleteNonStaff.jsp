            ...
            <table class="table table-striped">
                <tr><th style="width :20%">
                    ...
                    <th style="width :80%">
                        ...
                        <form:form class="form-horizontal" action="DeleteNonStaff_POST"  modelAttribute="temporaryemployee"   method="POST"  id="reg_form">
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <label class="col-md-4 control-label">Delete Employee</label>
                                    <div class="col-md-6  inputGroupContainer">
                                        <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                            <form:input name="submit" path="id"  placeholder="Employee ID" class="form-control"  type="text" />
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="text-center" >
                                        ...
                                        <button type="submit" class="btn btn-warning btn-lg"   > Delete Employee  </button>
