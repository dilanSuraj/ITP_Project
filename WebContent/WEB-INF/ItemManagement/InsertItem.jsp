			...
			<div class="col-md-12">
				<div class="card mb-3">
					<div class="card-header" style="color: #003399">
						<h5>
							<span class="fa fa-plus-square"></span> Add New Item
						</h5>
					</div>
					<div class="card-body">
          ...
          -->
									...
									<table id="example" class="table table-striped table-bordered"
										...
										<table id="example" class="table table-striped table-bordered"
											...
											<form:form method="post" action="InsertItem_POST"
												modelAttribute="item">
												...
												<div class="form-group">
													...
													<form:input type="text" class="form-control"
														path="item_type" placeholder="Item Type"></form:input>
												</div>
												...
												<div class="form-group">
													...
													<form:input type="text" class="form-control"
														path="item_name" placeholder="Item Name"></form:input>
												</div>

												<div class="form-group">
													<label for="input_amt">Supplier Name</label>
													<form:select id="inputState" class="form-control"
														path="supplierID" required="true">
														<c:forEach var="supplierList"
															items="${supplierList}" varStatus="status">
															<form:option
																value="${supplierList.getSupplier_ID()}">${supplierList.getSupplier_name()}</form:option>
														</c:forEach>
													</form:select>
												</div>
												...
												<button type="submit" class="btn btn-primary"
													name="add_stock">Insert Item Details</button>
