    ...
    <div class="navbar-collapse collapse w-100 order-3 dual-collapse2"  id="navbarNav">
        <ul class="navbar-nav ml-auto navbar-icons">
            ...
            <div class="d-block d-md-none">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#"  style="color: white"><span class="fa fa-plus " style="font-size: 18px"></span>   Order History</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#"  style="color: white"><span class="fa fa-plus " style="font-size: 18px"></span>   Cart</a>
                </li>
