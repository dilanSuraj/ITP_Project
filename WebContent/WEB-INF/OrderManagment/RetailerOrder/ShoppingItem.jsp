		...
		<div class="col-md-10"
			...
			<div class="container" style="margin-top: 80px">
				<div class="row">
					...
					<div class="col-md-6">
						<br>
						<h1><small>${Item.getItem_name()}</small></h1>
						<br>
						<h4><small>Rs.${Item.getItem_saleprice()} per
							unit</small></h4>
						<br>
						
						<form  onsubmit="return confirm('Do you want to add this Item to the cart?');" action="add_to_cart" class="form-group">
