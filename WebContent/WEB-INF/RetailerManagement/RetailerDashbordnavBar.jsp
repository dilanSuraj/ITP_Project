         ...
         <ul class="navbar-nav ml-auto navbar-icons">
             ...
             <div class="d-block d-md-none">
                 ...
                 <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                     ...
                     <div class="dropdown-divider"></div>
                     <a class="dropdown-item" href="batteries"  style="color: black">Alloy Wheel</a>
                 </div>
             </li>  
             ...
             <li class="nav-item">
                 <a  href="update_GET"  class="admin-name">Eshan A.M.N</a>
             </li>
             ...
             <li class="nav-item">
                 <a href="login" button type="button" class="btn btn-dark btn-sm "> <span class="fa fa-key"></span> Logout</a>
             </li>
         ...
         <ul class="nav flex-column sidbar-items">
			 ...
			 <li class="nav-item dropdown">
                 ...
                 <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                     ...
                     <div class="dropdown-divider"></div>
                     <a class="dropdown-item" href="alloywheel"  style="color: black">Alloy Wheel</a>
                 </div>
             </li> 
			 
             <li class="nav-item">
                 <a class="nav-link " href="RetailerCart" ><span class="fa fa-shopping-cart" style="font-size: 18px"></span>
                     Cart</a>
             </li>
             <li class="nav-item">
