			...
			<div class="col-md-12">
				<div class="card mb-3">
					<div class="card-header" style="color: #003399">
						<h5>
							<span class="fa fa-plus-square"></span> Add New Stock
						</h5>
					</div>
					<div class="card-body">
										...
										<table id="example" class="table table-striped table-bordered"
											...
											<form:form method="post" action="InsertStock_POST"
												...
												<div class="form-group">
													<label for="input_amt">Stock Item Name</label>
													<form:select id="inputState" class="form-control"
														path="stock_itemcode" required="true">
														<c:forEach var="itemList" items="${itemList}"
															varStatus="status">
															<form:option value="${itemList.getItem_itemcode()}">${itemList. getItem_name()}</form:option>
														</c:forEach>
													</form:select>
												</div>
												...
												<div class="form-group">
													<label for="inputAddress">StockAmount</label>

													<form:input type="number" min="1" class="form-control"
														path="stock_amount" placeholder="Enter stock_amount"
														required="required"></form:input>
												</div>

												<button type="submit" class="btn btn-primary"
													name="add_stock">Insert</button>
