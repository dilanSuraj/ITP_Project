                ...
                <div class="card-body">
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="inputname" placeholder="Company Name">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="contactNo" placeholder="Apartment, studio, or floor">
                        </div>
                        <div class="form-row">
