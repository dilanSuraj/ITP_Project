  ...
  <div class="col-md-12">
         <div class="card mb-3" >
             <div class="card-header" style="color: #003399" >
                 <h5><span class="fa fa-pencil"></span> Add Vehicle</h5></div>
             <div class="card-body">

                 <form:form method="post"
                 onSubmit = "return confirm('Do you want to add details')"
                  action="Transport_Manager_Add_POST" modelAttribute="vehicle">
                     <div class="form-row">
                         <div class="form-group col-md-6">
                             <label for="inputEmail4">Vehicle Number</label>
                             <form:input type="text" required = "required" class="form-control" path="vehicle_number" placeholder="QZ-1521"></form:input>
                         </div>
                         <div class="form-group col-md-6">
